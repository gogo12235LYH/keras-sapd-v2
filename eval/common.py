...
def evaluate(
    ...
    for label in range(generator.num_classes()):
        ...
        num_tp += 0 if true_positives.shape[0] == 0 else true_positives[-1]
        num_fp += 0 if false_positives.shape[0] == 0 else false_positives[-1]
...
#     from models.FeatureSelect import FeatureSelectModel_V1
#     import os
#
...
#         **common_args
#     )
#     model_path = '../1014_EP13_B0_R50_b2.h5'
#     input_shape = (test_generator.image_size, test_generator.image_size)
#     num_classes = test_generator.num_classes()
#     model, prediction_model = FeatureSelectModel_V1(num_cls=num_classes, batch_size=1)
